...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $view['slots']->get('pageTitle', 'XPERX'); ?></title>
        ...
        <div class="row">
                ...
                <div class="panel" name="form-login">
                    <div class="panel-body">
                        <div class="mautic-logo img-circle mb-md text-center">
                           <img style="width:150px" src="/media/images/xperx-logo.png">
                        </div>
         ...
         <div class="row">
            <div class="col-lg-4 col-lg-offset-4 text-center text-muted">
                Copyright &copy; <?php echo date("Y"); ?> XPERX AI. All rights reserved.
            </div>
        </div>
    </div>
</section>
