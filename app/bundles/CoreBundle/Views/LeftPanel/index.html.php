...
<div class="sidebar-header">
    <!-- brand -->
    <a class="xperx-brand<?php echo (!empty($extraMenu)) ? ' pull-left pl-0 pr-0' : ''; ?>" href="#">
        <!-- logo figure -->
        <img class="img-responsive media-object" style="width:90px" src="/media/images/xperx-logo-white.png" alt="XPERX AI">
        <!--/ logo figure -->
    </a>
